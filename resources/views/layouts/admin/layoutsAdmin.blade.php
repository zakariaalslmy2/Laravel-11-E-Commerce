...
<head>
    ...
    <link rel="stylesheet" type="text/css" herf="{{ asset('css/animate.min.css') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/animation.css') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/style.css') }}">
    <link rel="stylesheet"herf="{{ asset('font/fonts.css') }}">
    <link rel="stylesheet"herf="{{ asset('icon/style.css') }}">
    <link rel="shortcut icon"herf="{{ asset('images/favicon.ico') }}">
    <link rel="apple-touch-icon-precomposed"herf="{{ asset('images/favicon.ico') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/sweetalert.min.css') }}">
    <link rel="stylesheet" type="text/css"herf="{{ asset('css/custom.css') }}">
